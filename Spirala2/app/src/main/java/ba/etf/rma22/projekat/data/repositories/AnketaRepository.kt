...
object AnketaRepository {
    ...
    private val allAnketaList = mutableListOf(
        ...
        Anketa("anketa2", "nazivistrazivanja1", Date(1641060180000), Date(1657731780000), null, 10, "grupa2", 0F),
        Anketa("anketa3", "nazivistrazivanja1", Date(1640991600000), Date(1657731780000), null, 10, "grupa6", 0.0F),
        ...
        Anketa("anketa11", "nazivistrazivanja4", Date(1649091780000), Date(1642201200000), null, 10, "grupa7", 0F),
